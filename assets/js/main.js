...
function openPokemonModal(event) {
	...
	modal.innerHTML = `	<section class="pokemonDetail grass">
	...
	if (activeModal) {
		const previousCloseButton = activeModal.querySelector('.close-button');
		previousCloseButton.removeEventListener('click', closePokemonModal);
	}
